...
export const AdminRoutes = {
  ...
  /**
   * The route to the note sequences page.
   */
  noteSequences: createRouteDefinition('/note-sequences', {
    prefix: adminPrefix,
  }),

  /**
   * The route to the note sequence page.
   */
  noteSequence: createRouteDefinition<{ id: string }>('/note-sequences/:id', {
    prefix: adminPrefix,
  }),
  ...
  /**
   * The route to the tunes page.
   */
  tunes: createRouteDefinition('/tunes', { prefix: adminPrefix }),

  /**
   * The route to the tune page.
   */
  tune: createRouteDefinition<{ id: string }>('/tunes/:id', {
    prefix: adminPrefix,
  }),
};
